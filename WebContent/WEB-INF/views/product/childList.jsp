...
<script charset="utf-8" src="${ly }/js/childProduct.js"></script>
<style type="text/css">
body {
	padding: 0px;
}
...
<body>
	...
	<div class="div1_2">
		...
		<form action="${ly}/product/${brandType}/childProList.html" method="post"
			...
			<input type="button" id="addbut" name="addbut" value="新增" onclick="javascript:window.location.href='${ly}/product/${brandType}/showEditChildProduct.html';"/>
