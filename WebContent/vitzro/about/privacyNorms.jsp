...
<title><spring:message code="zkmed.index"/>|<spring:message code="zkmed.help.privacy"/></title>
</head>
<body>
...
<div class="temp_area">
	<div class="fl left">
    	<div class="left_tit"><h2><spring:message code="zkmed.help.privacy"/></h2></div>
        <div class="left_menu">
        	<div class="menu_box">
            	<script type="text/javascript">
                	$(function(){
    ...
    <div class="fr right">
    	<div class="url tr"> <a href="${ctx}/index.html?locale=${language}"><spring:message code="zkmed.index.index"/></a> &gt; <a href="#" class="curr_url" ><spring:message code="zkmed.help.privacy"/></a></div>
        
        <div class="right_tit"><h2><span><spring:message code="zkmed.index"/></span><spring:message code="zkmed.help.privacy"/></h2></div>
