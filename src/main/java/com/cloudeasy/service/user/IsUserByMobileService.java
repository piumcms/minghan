...
* @Description: TODO(根据根据手机获取User) 
* @author TBS
* @date Dec 12, 2013 8:52:19 PM 
* @version V1.0
 */
@Service("isUserByMobileService")
public  class IsUserByMobileService extends BaseService<Result,User>{
	...
	public Result execute(User arg) throws Exception {
		...
		if (arg.getUsername()!= null) {
			...
			dto.setMobile(arg.getMobilePhone());
			int cout = userMapper.isUserMobile(dto);
